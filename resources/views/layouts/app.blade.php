...
<html lang="es" class="light-style  layout-menu-fixed   " dir="ltr" data-theme="theme-default" data-assets-path="/assets/" data-base-url="" data-framework="laravel" data-template="vertical-menu-theme-default-light">
...
<head>
    ...
    <!-- laravel CRUD token -->
    <meta name="csrf-token" content="h58L2pFUYRgBd2yrnWePpwJrR5FUVBacy1GWaIaM">
    <!-- Canonical SEO -->
    ...
    <!-- Page Styles -->
    <!-- Page -->
    <link rel="stylesheet" href="/assets/vendor/css/pages/cards-advance.css{{ asset('/assets/css/demo.css') }}">
  ...
  <div class="container-xxl">
    <div class="footer-container d-flex align-items-center justify-content-between py-2 flex-md-row flex-column">
      <div>
        ...
        , creado por <a href="https://coderic.org" class="fw-semibold">Coderic</a>
      </div>
      <div>
        <a href="#" class="footer-link me-4">Lipsum</a>
        <a href="#" class="footer-link me-4">Lipsum</a>
        <a href="#" class="footer-link me-4">Lipsum</a>
        <a href="#" class="footer-link d-none d-sm-inline-block">Lipsum</a>
      </div>
    </div>
  </div>
</footer>
