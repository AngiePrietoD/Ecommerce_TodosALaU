            ...
            <table class="table-auto border w-full">
                <thead class="text-xs font-semibold uppercase text-white bg-sky-500">
                    <tr>
                        ...
                        <th class="p-2 text-left w-10 sm:w-28"><span class="inline-block sm:hidden">Tran</span><span class="hidden sm:inline-block">Transporte</span></th>
                    </tr>
                </thead>
