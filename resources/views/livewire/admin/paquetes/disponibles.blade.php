        ...
        <div class="mb-4 flex items-center">
            <div class="grow">
                ...
                <div class="relative">
                    ...
                    <input type="search" title="" wire:model="search" id="default-search" class="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                </div>
            </div>
        </div>
        <table class="table-auto border w-full">
            <thead class="text-xs font-semibold uppercase text-white bg-sky-500">
                <tr>
                    ...
                    <th class="border p-2 text-left hidden sm:table-cell">
                    ...
                    <th class="border p-2 text-left hidden md:table-cell">
                    ...
                    <th class="border p-2 w-10 hidden sm:table-cell">Fotos</th>
                    <th class="border p-2 text-left">
            ...
            <tbody class="text-sm divide-y divide-gray-100">
                ...
                <tr class="odd:bg-white even:bg-slate-50" wire:key="package-{{$package->id}}">
                    ...
                    <td class="border px-2 py-1 hidden sm:table-cell">
                        {{ $package->dispatch->code }}
                    </td>
                    ...
                    <td class="border px-2 py-1">
                        <a href="{{ route('admin.disponibles.user', $package->user->id) }}">
                    ...
                    <td class="border px-2 py-1 text-center hidden sm:table-cell">
                        ...
                        <button type="button" class="inline-block rounded bg-primary w-8 h-8 items-center text-xs font-medium uppercase leading-normal text-white shadow transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow focus:bg-primary-600 focus:shadow focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow dark:shadow dark:hover:shadow dark:focus:shadow dark:active:shadow">
                    ...
                    <td class="border px-2 py-1 text-center">
                        <button type="button" wire:click="entregar({{$package->id}})" class="inline-block rounded bg-green-500 w-8 h-8 items-center text-xs font-medium uppercase leading-normal text-white shadow transition duration-150 ease-in-out hover:bg-green-600 hover:shadow focus:bg-green-600 focus:shadow focus:outline-none focus:ring-0 active:bg-green-700 active:shadow dark:shadow dark:hover:shadow dark:focus:shadow dark:active:shadow">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mx-auto">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M11.35 3.836c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m8.9-4.414c.376.023.75.05 1.124.08 1.131.094 1.976 1.057 1.976 2.192V16.5A2.25 2.25 0 0118 18.75h-2.25m-7.5-10.5H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V18.75m-7.5-10.5h6.375c.621 0 1.125.504 1.125 1.125v9.375m-8.25-3l1.5 1.5 3-3.75" />
                            </svg>
                        </button>
