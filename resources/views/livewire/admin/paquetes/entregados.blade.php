<div>
    ...
    <div class="mt-2 p-3 sm:mt-4 sm:p-6 bg-white sm:container mx-auto">
        ...
        <table class="table-auto border w-full">
            <thead class="text-xs font-semibold uppercase text-white bg-sky-500">
                <tr>
                    ...
                    <th class="border p-2 text-left hidden sm:table-cell">
                        <span class="flex items-center cursor-pointer" wire:click="sortBy('delivered_at')">
                            Entregado
                    ...
                    <th class="border p-2 text-left"><span class="inline-block sm:hidden">Tran</span><span class="hidden sm:inline-block">Transporte</span></th>
                </tr>
            </thead>
            <tbody class="text-sm divide-y divide-gray-100">
                ...
                <tr class="odd:bg-white even:bg-slate-50" wire:key="package-{{$package->id}}">
                    ...
                    <td class="border px-2 py-1 hidden sm:table-cell">{{ $package->delivered_at }}</td>
                    <td class="border px-2 py-1">
                        <a href="{{ route('admin.tracking', $package->id) }}">
                            {{ $package->tracking }}
                        </a>
                    </td>
                    <td class="border px-2 py-1">{{ $package->user->name }} {{ $package->user->lastname }}</td>
                    ...
                    <td class="border px-2 py-1">
                        <div class="flex items-center">
                            <img class="w-8 h-8 border-0 mr-2" src="/images/transport-{{$package->transport->id}}.svg">
